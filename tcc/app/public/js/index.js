...
let interval; // variável para guardar o setInterval
...
document.querySelector('.prev').addEventListener('click', () => {
    clearInterval(interval); //  Limpa o autoplay atual para evitar conflito
    indice = (indice - 1 + imagens.length) % imagens.length;
    mostrarImagem();
    iniciarAutoplay(); // Reinicia o autoplay após o clique manual
});
...
// Inicia a exibição da primeira imagem e o autoplay quando a página carrega
